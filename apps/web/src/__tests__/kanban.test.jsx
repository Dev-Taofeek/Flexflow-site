...
jest.mock("@/i18n", () => ({
    useI18n: () => ({ t: (key) => mockI18nMap[key] || key }),
}));

jest.mock("@/hooks/useRole", () => ({
    useRole: () => ({ canManageTasks: true }),
}));
...
const MOCK_TASKS = [
    ...
    { id: "i5", title: "Unblock release", status: "BLOCKED",     priority: "HIGH",   assignee: null, dueDate: null, labels: [] },
];
...
describe("KanbanBoard", () => {
    ...
    it("places tasks in the correct columns", () => {
        ...
        expect(screen.getByText("Unblock release")).toBeInTheDocument();
    });

...
export default function SettingsLayout({ children }) {
    ...
    const NAV = [
        ...
        { href: "/settings/sso",          label: t("shell.settings.nav.sso"),          show: isAdmin && can("sso") },
        { href: "/settings/security",     label: t("shell.settings.nav.security"),     show: isAdmin && can("advanced_security") },
        { href: "/settings/custom-integrations", label: t("shell.settings.nav.customIntegrations"), show: isAdmin && can("custom_integrations") },
        { href: "/settings/audit-logs",   label: t("shell.settings.nav.auditLogs"),    show: isAdmin && can("audit_logs") },
        { href: "/settings/data",         label: t("shell.settings.nav.data"),         show: isAdmin && can("data_retention") },
        { href: "/settings/support",      label: t("shell.settings.nav.support"),      show: isAdmin && can("dedicated_support") },
    ].filter((n) => n.show);
